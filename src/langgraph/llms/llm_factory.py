...
class LLMFactory:
    ...
    def get_llm_model(self):
        ...
        try:
            if provider == "Groq":
                groq_api_key = self.user_controls_input["GROQ_API_KEY"] or st.secrets.get("GROQ_API_KEY", "") or os.environ.get("GROQ_API_KEY", "")
                ...
                openai_api_key = self.user_controls_input["OPENAI_API_KEY"] or st.secrets.get("OPENAI_API_KEY", "") or os.environ.get("OPENAI_API_KEY", "")
